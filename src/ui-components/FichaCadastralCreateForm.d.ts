...
export declare type FichaCadastralCreateFormInputValues = {
...
export declare type FichaCadastralCreateFormValidationValues = {
...
export declare type FichaCadastralCreateFormOverridesProps = {
    FichaCadastralCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type FichaCadastralCreateFormProps = React.PropsWithChildren<{
    overrides?: FichaCadastralCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: FichaCadastralCreateFormInputValues) => FichaCadastralCreateFormInputValues;
    onSuccess?: (fields: FichaCadastralCreateFormInputValues) => void;
    onError?: (fields: FichaCadastralCreateFormInputValues, errorMessage: string) => void;
    onCancel?: () => void;
    onChange?: (fields: FichaCadastralCreateFormInputValues) => FichaCadastralCreateFormInputValues;
    onValidate?: FichaCadastralCreateFormValidationValues;
} & React.CSSProperties>;
export default function FichaCadastralCreateForm(props: FichaCadastralCreateFormProps): React.ReactElement;
