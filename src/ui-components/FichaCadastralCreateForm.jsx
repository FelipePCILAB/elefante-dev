...
export default function FichaCadastralCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCnpjCpf(initialValues.cnpjCpf);
    setIeRg(initialValues.ieRg);
    ...
    setTelefoneCompras(initialValues.telefoneCompras);
    setEmailCompras(initialValues.emailCompras);
