...
export default function PerfilMedico(props) {
  const { fichaCadastral, eventoClique, overrides, ...rest } = props;
  return (
    <Flex
      gap="24px"
      direction="column"
      ...
      {...getOverrideProps(overrides, "PerfilMedico")}
      {...rest}
    >
      <Flex
        gap="8px"
      ...
      >
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children={fichaCadastral?.enderecoCompleto}
